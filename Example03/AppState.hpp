...
public:
	...
	virtual void manageAppState(String stateName, AppState* state) = 0;

	virtual AppState*    findByName(String stateName) = 0;
...
class AppState : public KeyListener, public MouseListener, public SdkTrayListener
{
public:
	static void create(AppStateListener* parent, const String name)
	{
		//
	};
